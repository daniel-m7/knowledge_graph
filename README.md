...
# Forked Project Changes
The following are the changes I have made to forked project
- Replaced NetworkX repository with Neo4j graph repository in the [Jupyter notebook](./extract_graph.ipynb)
- Replaced Pyvis with Neo4j browser visualization

The rest of the code is left intact and all credits go to the author of the original repository at https://github.com/rahulnyk/knowledge_graph 
